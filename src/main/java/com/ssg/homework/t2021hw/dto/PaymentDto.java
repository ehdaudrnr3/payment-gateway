...
public class PaymentDto {
	...
	public PaymentDto(Payment payment) {
		this.pmtId = payment.getPmtId();
		this.mbrId = payment.getMember().getMbrId();
		this.pmtCode = payment.getPmtCode();
		this.pmtType = payment.getPmtType();
		this.succYn = payment.getSuccYn();
		this.succMsg = payment.getSuccMsg();
		this.aprvType = payment.getAprvType();
		this.aprvTime = payment.getAprvTime();
		this.pmtAmt = payment.getPmtAmt();
	}
